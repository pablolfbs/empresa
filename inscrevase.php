...
<body>
	<header>
		<nav class="navbar navbar-expand-sm navbar-light bg-light">
			<div class="container">
				<a class="navbar-brand" href="#"> <img src="img/logo.png" width="40"
					height="40" />
				</a>
				...
				<div class="collapse navbar-collapse justify-content-end"
					...
					<ul class="navbar-nav float-left">
						<li class="nav-item active"><a class="nav-link" href="index.php">voltar
								para home <span class="sr-only">(current)</span>
						</a></li>
					</ul>
				</div>
			</div>
				...
				<form method="post" action="registra_usuario.php"
					...
					<div class="form-group">
						<input type="text" class="form-control" id="usuario"
							name="usuario" placeholder="Usuário" required="requiored">
						<?php
    if ($erro_usuario) {
    ...
    ?>
					...
					<div class="form-group">
						<input type="email" class="form-control" id="email" name="email"
							placeholder="Email" required="requiored">
						<?php
    if ($erro_email) {
    ...
    ?>
					...
					<div class="form-group">
						<input type="password" class="form-control" id="senha"
							name="senha" placeholder="Senha" required="requiored">
					</div>
